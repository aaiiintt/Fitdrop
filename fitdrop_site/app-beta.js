...
// Initialize Renderer
// OPTIMIZATION REMOVED FOR BETA: Testing if uncapped native ratio fixes Windows offset input bug
// const pixelRatio = Math.min(window.devicePixelRatio, 2);
const pixelRatio = 'auto'; // Let Matter.js / Browser handle it natively
...
const render = Render.create({
    ...
    options: {
        ...
        background: '#f4f4f4',
        // pixelRatio: pixelRatio, // Removed explicit override
        wireframes: false,
